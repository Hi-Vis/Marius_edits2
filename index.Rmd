...
req_packages = c('car', 'carData', 'sjPlot', 'effects', 'readxl', 'tidyr',
                 'svglite')

lapply(reg_packages, function(pkg) {
...
You can also download PDF and epub versions of all the material
using the toolbar at the top. Right now the material is being
regularly updated, so please remember to check for updates:
