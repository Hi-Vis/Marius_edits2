...
So far we've dealt with complex recoding tasks, to demonstrate how
you can use R to tackle complex data. But all the basic
recoding tools you'd expect are available. The most basic
tool is converting the numeric codes we've used above into 
labelled factors:
